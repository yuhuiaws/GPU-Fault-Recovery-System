...
def test_formal_plan_expands_complete_order_and_serial_dependency_chain() -> None:
    ...
    # 189 catalogued cases (COLLECT-021 added 2026-09-08, the BOOT-024..028
    # admin lifecycle chain added 2026-09-12); 10 are DO_NOT_RUN (two retired
    # earlier, seven folded into their supersets on 2026-09-07, plus BOOT-006
    # deleted with quick triage), so 179 run.
    retired = (
