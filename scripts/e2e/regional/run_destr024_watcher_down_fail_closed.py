...
def execute_case(
    ...
    try:
        ...
        # The watcher returns; its first idle pass posts a heartbeat at once
        # (the 120 s built-in interval starts counting from that post), and it
        # has to advance past the stale one.
