...
一次完整部署有 **11 类长驻进程**（含 0 副本的泄压角色），分布在三层。业务代码拆为
...
现场验收规格是 `docs/区域模式端到端验收测试用例.md`，共 **153** 个稳定编号用例，
...
81 条路由、153 个用例、26 个 kind、19 类通知）都是我装配真实 app 或读真实文件数出来的，
...
| [区域模式端到端验收测试用例.md](区域模式端到端验收测试用例.md) | 现场验收规格，153 个用例 |
