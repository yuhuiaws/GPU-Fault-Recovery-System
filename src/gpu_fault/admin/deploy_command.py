...
class DeployHooks:
    ...
    schema_change_environment: Callable[[argparse.Namespace], dict[str, str]]
    supersede_environment: Callable[[argparse.Namespace], dict[str, str]]
    ...
    *,
    ...
    status = int(
        hooks.run_source_deploy(
            ...
            extra_environment={
                **hooks.schema_change_environment(arguments),
                **hooks.supersede_environment(arguments),
