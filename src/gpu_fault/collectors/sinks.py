...
# is what the CLI, the tests and the runbooks name.
from gpu_fault.collectors.outbox_file import (  # noqa: F401 -- re-export
...
#: Outbox paths whose own write failed: bounded logs, plus how long a
#: degradation has lasted. Counted under the file layer's lock (see
#: :mod:`gpu_fault.collectors.outbox_file`) so both tables share one mutex.
